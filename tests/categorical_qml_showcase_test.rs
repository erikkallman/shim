...
mod tests {
    ...
    use categorical_qc::machine_learning::categorical::categories::{ModelCategory, DataCategory, CircuitCategory};
    use categorical_qc::machine_learning::categorical::functors::{DataToCircuitFunctor, CircuitToModelFunctor};
    use categorical_qc::machine_learning::categorical::transformations::{StatePreparationTransformation, ModelPredictionTransformation, CircuitPredictionTransformation};
    use categorical_qc::machine_learning::quantum::model::{DecodingStrategy, EncodingStrategy};
    use categorical_qc::machine_learning::categorical::prediction::{PredictionCategory, PredictionTransformation};
    use categorical_qc::machine_learning::dataset::TabularDataset;
    ...
    use categorical_qc::machine_learning::dataset::Dataset;
